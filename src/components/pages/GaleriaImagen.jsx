  ...
  const fotos = [
    {
      ...
      fotoPrincipal: {
        src: "https://plus.unsplash.com/premium_photo-1681487479203-464a22302b27?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        alt: "Habitaciones",
      },
      fotos: [
        {
    ...
    },
    {
      ...
      fotoPrincipal: {
        src: "https://t2.uc.ltmcdn.com/es/posts/5/2/3/tirar_de_la_cuerda_52325_7_600.jpg",
        alt: "Recreacion",
      },
      fotos: [
        {
    ...
    },
    {
      ...
      categoria: "Piscina",
      fotoPrincipal: {
        src: "https://s2.abcstatics.com/abc/www/multimedia/viajar/2024/06/26/08-daia-conil-piscina-04-RYUK2nnTBMBM9r4gi3EoiVO-1200x840@diario_abc.jpg",
        alt: "Piletas",
      },
      fotos: [
        {
    ...
    },
    {
      ...
      categoria: "Terraza",
      fotoPrincipal: {
        src: "https://live.staticflickr.com/8166/7313617034_e2de794c1e_b.jpg",
        alt: "Terrazas",
      },
      fotos: [
        {
        ...
        <div className="row justify-content-around">
          {!categoriaSeleccionada ? (
            fotos.map((categoria) => (
              <div
                key={categoria.id}
                className="col-10 col-md-6 col-lg-4 my-2 py-2 foto">
