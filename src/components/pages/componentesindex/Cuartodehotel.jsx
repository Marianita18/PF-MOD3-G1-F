       ...
       // 1280: { slidesPerView: 4, spaceBetween: 40 }
         ...
         <SwiperSlide>
           <div className="dormitorios">
            <motion.img  whileHover={{ scale: 1.2,zIndex:10}}transition={{ duration: 1.6 }}  src="/Dormitorios/00591813-dormitorio-cuadro-beige-ocre-silla-cuadro_ac8bd2b6_00591813_241023105458_600x600.webp" alt="plato" className="img-dormitorio"
              />
             </div> 
         </SwiperSlide>
         <SwiperSlide>
